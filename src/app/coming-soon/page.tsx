    ...
    <div style={{ fontFamily: dmSans, color: '#1A1A2E', background: '#F9F9FB' }}>
      ...
      <div style={{ background: '#E91E8C', padding: '14px 24px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 20, flexWrap: 'wrap' }}>
        <span style={{ fontFamily: outfit, fontWeight: 700, fontSize: 15, color: 'white', letterSpacing: '0.02em' }}>
          🎵 Next Vinyl &amp; Vibe-Along Sunday 14 June &middot; 12pm Brisbane &middot; 2pm NZ &middot; 6 spots only
        </span>
        <Link
          href="/sign-up"
          ...
          <div style={{ marginTop: 40 }}>
            {[
              ...
              },
              {
                ...
                desc: "Our next session is 14th June (12pm Brisbane / 2pm NZ) where we take you from zero to hero - you'll get to vibe code your own web app.",
              },
              {
                title: 'Keep Learning',
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 16 }}>
            <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
              <a href="https://www.facebook.com/jetpackersAI" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={{ color: '#9999BB' }}>
              ...
              <a href="https://www.youtube.com/@jetpackersAI" target="_blank" rel="noopener noreferrer" aria-label="YouTube" style={{ color: '#9999BB' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </a>
              <a href="https://www.instagram.com/jetpackersai/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: '#9999BB' }}>
            ...
            <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' as const }}>
              <Link href="/quiz" style={{ color: '#9999BB', fontSize: 14, textDecoration: 'none' }}>Quiz</Link>
              <Link href="/privacy" style={{ color: '#9999BB', fontSize: 14, textDecoration: 'none' }}>Privacy</Link>
              <Link href="/terms" style={{ color: '#9999BB', fontSize: 14, textDecoration: 'none' }}>Terms</Link>
            </div>
          </div>
          <div />
          <div
